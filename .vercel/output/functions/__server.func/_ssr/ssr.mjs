...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DCumbiBR.mjs");
...
var manifest = {
	"15fc56555351003ab9c039faf61191937c940e7ff35208836d8a34fd4fd750b1": {
		functionName: "loadHud_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"3b22a510c847610121392428e904516fbb61d824f3350a6165f7c402e70d00b0": {
		functionName: "saveSettings_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"7670c691746d1e81bf6f705075ff133fdd1a2fe3367ddae750614dd53189ea57": {
		functionName: "testVpsLink_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"a6d1932bcf20911a87be4610c4d81b7b4f64b10065f70a86e99ab4bd55ff97b3": {
		functionName: "askSovi_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"c33bad44684c41e0d42c5d01f7d2a6839fc0fb62c20d66d13dfb680b84716e89": {
		functionName: "transcribeUtterance_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"cc44d8ed6d37c9fd7637741ad323b243085dc8d4ab2b734a52e1c1db1ab0cf10": {
		functionName: "clearTranscript_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	},
	"d208dfba17967b420fab93a238bcf086e7a50fc5bbd3c32d18e505d44cfd54b0": {
		functionName: "markAlertRead_createServerFn_handler",
		importer: () => import("./server-ofb_elOe.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-dTHMS0Fw.mjs").then((n) => n.t),
