...
import { n as auth } from "./server-D3cu_fSe.mjs";
import { i as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-dTHMS0Fw.js
var router_dTHMS0Fw_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Cp8CAv7E.css";
var APP_NAME = "Sovi";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Sovi — Sovereign voice interface. Talk to your stack like Iron Man talks to JARVIS."
			},
			{
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Rajdhani:wght@500;600;700&family=Share+Tech+Mono&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-GiKMkG7N.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-D-EDQXda.mjs");
...
//#endregion
export { getRouter, router_dTHMS0Fw_exports as t };
